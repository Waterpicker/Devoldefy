...
public class Devoldefy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        perform(
            ...
            config.additionalClassMappings,
            config.additionalFieldMappings,
    ...
    private static void perform(
        ...
        boolean mcpToYarn,
        File cacheFileDir,
        Map<String, String> additionalClassMappings,
        Map<String, String> additionalFieldMappings,
        Map<String, String> additionalMethodMappings
    ) throws Exception {
        ...
        appendAdditionalMappings(
            additionalClassMappings, additionalFieldMappings, additionalMethodMappings, mappings
        );
    ...
    private static void appendAdditionalMappings(
        Map<String, String> additionalClassMappings,
        Map<String, String> additionalFieldMappings,
        Map<String, String> additionalMethodMappings,
        Mappings mappings
    ) {
        if (additionalClassMappings != null) {
            additionalClassMappings.forEach((a, b) -> {
                mappings.classes.put(a, b);
            });
        }
        if (additionalFieldMappings != null) {
            additionalFieldMappings.forEach((a, b) -> {
                mappings.fields.put(a, b);
            });
        }
        if (additionalMethodMappings != null) {
            additionalMethodMappings.forEach((a, b) -> {
                mappings.methods.put(a, b);
            });
        }
    }
